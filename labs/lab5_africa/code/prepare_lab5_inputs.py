"""Prepare canonical Lab 5 inputs from VIIRS, Afrobarometer, and adjacency extracts.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Map raw data sources into Lab 5 canonical inputs")
