"""Run reproducible robustness specs for the real-Europe Lab 3 RDD dataset.

This script orchestrates multiple Sharp RDD runs using
`lab3_europe_rdd_scaffold.py`, varying bandwidth, kernel, and
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run real-Europe Lab 3 RDD robustness specs")
    parser.add_argument(
        "--panel",
    ...
    parser.add_argument(
        "--scaffold-script",
        default="lab3_europe_rdd_scaffold.py",
