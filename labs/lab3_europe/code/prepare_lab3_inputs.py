"""Prepare canonical Lab 3 inputs from Eurostat GDP and eligibility data.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Map raw data sources into Lab 3 canonical inputs")
