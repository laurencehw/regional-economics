"""Run a baseline Synthetic Control for Lab 4 MENA panel.
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run Lab 4 SCM baseline")
    parser.add_argument(
        "--panel-csv",
    ...
    parser.add_argument(
        "--output-dir",
        default="labs/lab4_mena/output/scm_baseline",
