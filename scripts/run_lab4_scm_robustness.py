"""Run SCM placebo and robustness checks for Lab 4 MENA.
...
from run_lab4_scm_baseline import rmspe, solve_scm_weights


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Lab 4 SCM placebo / robustness checks")
    parser.add_argument(
        "--panel-csv",
        required=True,
    ...
    parser.add_argument(
        "--output-dir",
        default="labs/lab4_mena/output/scm_robustness",
    )
