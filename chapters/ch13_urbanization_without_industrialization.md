...
Lagos will be home to nearly 24 million people by 2030 (UN World Urbanization Prospects 2022), placing it among the fifteen largest cities on earth. It already generates around 30 percent of Nigeria's GDP (NBS Nigeria 2023). Yet Lagos has no steel mill, no globally competitive automobile plant, no semiconductor fab, and no pharmaceutical complex of international significance. Its economy is overwhelmingly services -- banking, telecommunications, logistics, entertainment, and the vast informal sector that employs most of its workforce.

The standard model of structural transformation -- codified by Lewis (1954) -- assumed urbanization and industrialization were the same process. Workers move from fields to factories; factories generate productivity gains through scale and specialization; productivity gains raise wages; higher wages finance the services that characterize a modern economy. Sub-Saharan Africa has broken this sequence. The region urbanizes at 4 percent per year (UN WUP 2022) -- faster than any other region in history at a comparable income level -- but manufacturing's share of GDP has remained flat or declined since the 1990s (World Bank 2021).
...
{% hint style="info" %}
**Case selection.** Lagos and Nairobi are the primary paired comparison (scale vs service capacity). Kigali, Accra, Johannesburg, and Addis Ababa appear as secondary poles; Sahelian capitals illustrate distress urbanization. Francophone West Africa and the Horn receive comparative notes below rather than full parallel diagnostics; Chapter 12 covers Sudan and related conflict/displacement cases in depth.
{% endhint %}
...
{% hint style="info" %}
**Production Cities vs. Consumption Cities.** Gollin, Jedwab, and Vollrath (2016) distinguish two modes of urbanization. *Production cities* grow because manufacturing and tradable services generate productivity gains, export earnings, and tax revenue that finance urban infrastructure --- the East Asian model. *Consumption cities* grow because resource rents (oil, minerals) circulate through the capital, generating demand for non-tradable services (banking, construction, retail) that attract migrants. A production city's growth is self-sustaining; a consumption city's growth is hostage to commodity prices. Many of Africa's fastest-growing metropolises --- Lagos, Luanda, Libreville --- are consumption cities.
{% endhint %}
...
{% hint style="info" %}
**Comparative note: Francophone West Africa and Ethiopia.** Abidjan and Dakar sit on the Abidjan–Lagos corridor with deeper port–customs institutions than most Sahelian capitals, yet still face the same density-without-manufacturing puzzle in French-speaking labor markets that are only partially integrated with Anglophone platform ecosystems. Ethiopia’s Addis Ababa / industrial-park strategy (Hawassa and related sites) is the clearest Horn attempt at manufacturing-led urbanization; it shows that park enclaves can create formal jobs without automatically thickening municipal service capacity city-wide — a caution against equating FDI park announcements with productive agglomeration. Sudan’s conflict-driven displacement (Chapter 12) is the extreme of distress urbanization and is not collapsed into this chapter’s municipal-capacity frame.
{% endhint %}
...
**Border-length weighting.** Lab 6's default $$W$$ optionally weights neighbors by shared border length (in kilometers). This is more informative than binary contiguity: Tanzania and Kenya share a long border (around 700 km) with substantial cross-border trade, while Tanzania and Malawi share a short border (close to 160 km) with less interchange. But border length is an imperfect proxy for economic interaction — some long borders run through uninhabited terrain (the Chad-Libya border, 1,000 km of Sahara Desert) while some short borders carry enormous traffic (the Kenya-Tanzania border at Namanga).
...
Cities do not exist in isolation. They are nodes in transport networks, and their economic function depends on their connectivity to other nodes — ports, markets, resource sites, and other cities. In Africa, where overland transport costs are the highest in the world (about $0.05–0.10 per ton-kilometer compared to $0.01–0.03 in Asia) (World Bank 2024), the location of a city relative to a trade corridor is a primary determinant of its economic viability.
...
The Northern Corridor — stretching 1,700 kilometers from the port of Mombasa, Kenya, through Nairobi, across the Ugandan border at Malaba, through Kampala, and onward to Kigali, Rwanda, and Bujumbura, Burundi — is the lifeline of East African trade. It carries 60 percent of the region's imports and exports (NCTTCA 2023).
...
The cumulative effect was dramatic: average transit time from Mombasa to Kigali fell from 22 days to 6 days by 2023. Trade volumes on the corridor increased by some 40 percent. Night-lights data along the corridor show measurable brightening at border posts and logistics hubs, consistent with increased economic activity driven by reduced trade costs.

The Northern Corridor reforms illustrate the chapter's central argument: institutional process reform — not infrastructure construction, not tariff reduction — was the operative bottleneck on regional trade. The roads were adequate (though not excellent); the ports were congested but functional; the tariffs were already low under the EAC Customs Union. What was missing was the institutional software — digital systems, harmonized procedures, coordinated governance — that allowed the hardware to function at capacity. This is the institutional complement to the hardware-centric development model, and it is the logic that the AfCFTA will need to replicate at continental scale.
