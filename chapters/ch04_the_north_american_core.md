...
On July 1, 2020, the United States-Mexico-Canada Agreement replaced NAFTA after twenty-six years of operation. The text ran to 2,300 pages — four times the length of the agreement it superseded (USTR 2020) — and its centerpiece was a set of automotive rules-of-origin provisions requiring extensive compliance systems. The headline rules phase in a 75-percent regional value-content threshold for passenger vehicles and light trucks, require producers to source at least 70 percent by value of their steel and aluminum purchases from North America, and require 40–45 percent of qualifying vehicle content to be produced by workers earning at least $16 per hour. A separate steel-processing rule takes effect in July 2027; the agreement does not impose an equivalent aluminum “smelt and cast” rule as of the 2026 data cutoff (USTR 2026).
...
{% hint style="info" %}
**Case selection.** The chapter treats the USMCA triad as one production system, with automotive ROO/LVC, border ports, and CHIPS/IRA place-based subsidies as the identifying shocks. Deep dives privilege Detroit–Windsor, Texas–northern Mexico, and Sun Belt fab corridors; Central America enters mainly via agricultural/nearshoring spillovers rather than as a full third North American case.
{% endhint %}
...
The stakes are large. North American goods trade exceeded $1.5 trillion in 2024 (US Census Bureau 2025), making this the world's most valuable trading corridor. More than 2 million jobs in each of the three countries depend directly on cross-border supply chains (USTR 2024). The spatial distribution of these jobs — and of the gains and losses from the ongoing policy transition — is the core empirical question of this chapter.
...
{% hint style="info" %}
**Maquiladora.** A maquiladora is a manufacturing plant in Mexico that imports raw materials and components duty-free under a special customs regime, assembles or processes them, and re-exports the finished or semi-finished products. Originating in the 1965 Border Industrialization Program, maquiladoras were designed to attract foreign (primarily US) investment to Mexico's northern border region. Under NAFTA and now USMCA, maquiladora operations must satisfy increasingly stringent rules-of-origin requirements to qualify for preferential tariff treatment.
{% endhint %}

- **Northern Mexico's maquiladora zone** (Chihuahua, Coahuila, Nuevo León, Tamaulipas) absorbed labor-intensive assembly, exploiting nominal wage differentials of nearly 8:1 (BLS 2024; INEGI 2024). The border cities — Ciudad Juárez, Reynosa, Monterrey — grew into industrial agglomerations of continental significance.
...
{% hint style="info" %}
**Nearshoring vs. Reshoring.** *Reshoring* refers to the relocation of manufacturing or services operations back to the firm's home country after a period of offshoring (e.g., a US firm moving production from China back to Ohio). *Nearshoring* refers to relocating operations not to the home country but to a nearby country with lower costs and geographic or time-zone proximity (e.g., a US firm moving production from China to Mexico). Both strategies reduce supply chain length and geopolitical risk relative to offshoring, but they have different spatial consequences: reshoring benefits domestic regions, while nearshoring benefits partner-country regions. Under USMCA, nearshoring to Mexico can satisfy rules-of-origin requirements that pure offshoring to Asia cannot.
{% endhint %}
...
{% hint style="info" %}
**Rules of Origin.** Rules of origin determine a product's origin for preferential tariff treatment. They can be based on regional value content, tariff classification changes, or specified production processes. Under USMCA's automotive rules, the vehicle and parts thresholds coexist with producer-level North American steel and aluminum purchase requirements; beginning in July 2027, qualifying steel under that purchase rule must satisfy regional manufacturing-process requirements from initial melting through coating.
{% endhint %}

**Higher and more granular rules of origin.** The automotive regional value-content threshold rose from 62.5 percent to 75 percent, with separate thresholds for core, principal, and complementary parts. Producers must also purchase at least 70 percent by value of both steel and aluminum from within North America. Beginning in July 2027, steel counts as originating under the purchase rule only when the covered manufacturing processes occur within the parties; in 2030 the parties must consider appropriate aluminum requirements (USTR 2026). These provisions raise documentation and sourcing burdens without implying that every kilogram of steel or aluminum in a qualifying vehicle originated regionally.

**Labor Value Content (LVC) provisions.** USMCA required that 40-45 percent of automotive content be produced by workers earning at least $16 per hour (USTR 2020) — the first trade agreement to link market access directly to wage levels. The effect was asymmetric: US and Canadian workers already exceeded the threshold, while Mexican maquiladora workers typically earned $3-5 per hour (INEGI 2023). Firms faced a choice between raising Mexican wages or relocating high-value-content production steps to the US and Canada.

**Rapid Response Labor Mechanism.** USMCA's enforcement chapter included a facility-level complaint mechanism for labor rights violations, allowing a panel to impose duties on specific factories found to be suppressing worker organizing. This was not merely aspirational: by 2025, the US had filed over a dozen rapid-response actions against specific Mexican facilities (USTR 2025), resulting in back pay, union elections, and, in some cases, loss of preferential treatment.

{% hint style="info" %}
**USMCA vs NAFTA --- Key Differences.** The auto regional value-content threshold rose from 62.5% to 75%. A Labor Value Content rule requires 40--45% of qualifying auto content to be produced by workers earning at least $16/hour. Producers face 70% North American steel and aluminum purchase requirements, with a regional steel-processing requirement beginning in July 2027. A Rapid Response Labor Mechanism permits facility-level enforcement of covered labor rights.
{% endhint %}
...
This has three geographic consequences that the trade literature is only beginning to absorb:
...
The chapter's manufacturing emphasis risks obscuring the sector that dominates several border corridors: agriculture. An estimated 60 percent of US winter produce crosses at Nogales (USDA 2023), Arizona, through the Salinas Valley-to-Sinaloa corridor. For perishable goods, the binding trade cost is not USMCA paperwork but phytosanitary inspection — a truckload of strawberries delayed twelve hours is a truckload of compost. Agricultural corridor economics hinge on inspection capacity and cold-chain logistics at specialized ports, a bottleneck that neither the gravity model's distance term nor USMCA's rules of origin adequately capture.
...
**Port-level heterogeneity is enormous.** Laredo, the largest commercial crossing on the US-Mexico border, handles around 15,000 commercial truck crossings per day (BTS 2024) across its two international bridges (the World Trade Bridge and the Colombia Solidarity Bridge combined). Nearby Eagle Pass handles a fraction of that volume, despite being only 200 kilometers away. The concentration of trade at a few mega-ports creates localized congestion effects: wait times at Laredo can exceed four hours during peak periods, while smaller ports operate with minimal delays. This spatial concentration of border traffic produces its own agglomeration economics — customs brokers, warehousing, logistics firms cluster near the busiest ports, reinforcing the pattern.
...
{% hint style="warning" %}
**Interpreting the Border Effect.** The "border effect" in trade economics measures how much an international boundary reduces trade relative to equivalent within-country distances. McCallum (1995) famously found that Canadian provinces traded 20 times more with each other than with equidistant US states. This result is sensitive to model specification, sample composition, and the treatment of multilateral resistance (Anderson and van Wincoop 2003). Lab 1's innovation is replacing the standard border dummy with a continuous, port-level friction measure --- but students should note that even continuous measures cannot fully separate border friction from unobserved cultural, legal, and institutional differences that happen to coincide with national boundaries.
{% endhint %}
...
The CHIPS and Science Act (2022) authorized $52.7 billion in direct subsidies for semiconductor manufacturing and research in the United States, with additional tax credits worth about $24 billion (Congressional Research Service 2023). The guardrails were explicit: firms receiving CHIPS funding were prohibited from expanding advanced semiconductor production in China for ten years and were required to demonstrate that their investments generated domestic supply chain benefits. This was industrial policy on a scale that the United States had not attempted since the Defense Production Act mobilizations of the Cold War. Award announcements, facility timelines, and firm-level investment figures cited below should be read as of the July 1, 2026 manuscript cutoff; later Commerce Department revisions are not silently substituted.

{% hint style="info" %}
**Nearshoring and Friend-shoring.** *Nearshoring* refers to relocating production from distant low-cost countries to geographically proximate partners --- e.g., from China to Mexico --- to reduce logistics risk and transit time while retaining cost advantages. *Friend-shoring* is the related practice of restricting supply chain participation to geopolitically aligned countries, regardless of cost. Both concepts entered mainstream policy discourse after the COVID-19 supply chain disruptions and are now embedded in CHIPS Act guardrails, USMCA compliance logic, and critical-minerals sourcing requirements. The distinction matters spatially: nearshoring favors Mexico and Central America; friend-shoring favors USMCA partners, the EU, Japan, South Korea, and Taiwan.
{% endhint %}
...
CHIPS Act investments are not spatially neutral. The three largest fab investments — TSMC in Phoenix ($40 billion) (TSMC 2024), Samsung in Taylor, Texas ($17 billion) (Samsung 2021), and Intel in Chandler, Arizona ($20 billion) (Intel 2023) — are all in the Sun Belt, in regions with existing semiconductor infrastructure, available land, and technically educated workforces. The Phoenix corridor is a real-time example of NEG circular causation.

But the concentration illustrates the Rust Belt paradox. The CHIPS Act aimed to revitalize manufacturing in communities that had lost it. In practice, investments flow to regions with thick institutional and human-capital endowments — the superstar dynamics Moretti (2012) documented. Syracuse, where Micron announced a $100 billion long-term investment (Micron 2022), is a partial exception, but Micron chose it for existing semiconductor research at SUNY Polytechnic and $5.5 billion in state incentives (New York State 2022).

Of the first twenty preliminary awards, sixteen went to states that already had semiconductor operations (Commerce Department 2024). States with no prior presence received none — the related-variety logic of Chapter 2 at work. CHIPS subsidies, funded by all taxpayers, produce concentrated benefits in already-prosperous regions.
...
The IRA (2022) — $369 billion in clean energy provisions (US Congress 2022) — creates a near-twin spatial dynamic. Its **48C Advanced Manufacturing Credits** (30 percent for solar, wind, and battery facilities), **Energy Community Bonus Credits** (10-point premium for counties with recent coal closures), and **45X Production Tax Credits** (per-unit credits for domestically manufactured clean energy components) produce explicitly place-based incentives.

The emerging spatial pattern mirrors CHIPS. Battery manufacturing concentrates in the "Battery Belt" — Tennessee, Georgia, Kentucky, Michigan — where existing automotive supply chains provide the base for rapid scaling. Rivian's Georgia facility, SK On's plants in Georgia and Kentucky, Toyota's battery factory in North Carolina, and a cluster of lithium-ion cell facilities in Tennessee collectively represent over $50 billion in announced investment (BEA 2024), mostly in counties that already had significant manufacturing employment. The energy-community bonus partially offsets this agglomeration tendency, directing some investment to formerly coal-dependent counties in Appalachia and Wyoming — but the bonus is small relative to the cost advantages of established corridors, and the pattern of concentration persists.
...
The defining spatial fact of twenty-first-century North America is internal divergence. Between 2001 and 2024, the five largest US metropolitan areas (New York, Los Angeles, Chicago, Dallas, Houston) generated some 25 percent of total GDP growth, while the fifty smallest metros collectively contributed less than 3 percent (BEA 2024). The pattern is similar in Canada, where the Toronto-Vancouver-Montreal triangle dominates growth statistics, and in Mexico, where Mexico City, Monterrey, and Guadalajara account for a disproportionate share of formal-sector value added.

Autor (2019) documented that between 1970 and 2015, the population-weighted coefficient of variation of per-capita income across US commuting zones *increased* by 30 percent — reversing the convergence trend prevailing since 1880. The divergence is driven by the upper tail: the richest 10 percent pulled away while the bottom 50 percent stagnated. Ganong and Shoag (2017) showed the reversal is partly explained by housing supply constraints in productive cities — high costs reduce the migration that would otherwise equalize wages — but housing supply is itself an institutional variable, shaped by zoning and NIMBYism.

The Canadian pattern is less extreme but directionally similar. Toronto's share of national GDP has grown from 18 percent in 2001 to nearly 22 percent in 2024 (Statistics Canada 2024), driven by the financial sector, technology, and immigration-fueled population growth. Atlantic Canada — New Brunswick, Nova Scotia, Prince Edward Island, Newfoundland — has declined in relative terms, despite persistent federal transfer payments designed to reduce regional inequality. Mexico's pattern is the most dramatic: the Mexico City metropolitan zone produces around 17 percent of national GDP (INEGI 2024) but houses only 16 percent of the population, while the southern states (Chiapas, Oaxaca, Guerrero) — home to 12 percent of the population — produce less than 5 percent of GDP and exhibit poverty rates comparable to Central America.
...
USMCA's compliance provisions may deepen this gradient. The LVC requirements and origin documentation burden favor the already-formal, already-integrated northern economy. Southern Mexico, where informality rates exceed 70 percent (INEGI 2024) and manufacturing is largely artisanal, cannot absorb compliance-intensive production. The policy implication — which the next chapter explores for Latin America more broadly — is that trade agreements designed in capitals benefit regions that are already integrated into the formal economy and leave behind those that are not.

### The Policy Tension

{% hint style="success" %}
**Key Finding: The Conditional Spillover Result.** Lab 1's central empirical finding is that spatial growth spillovers across the Western Hemisphere are not unconditionally positive. The baseline spatial lag coefficient is near zero. But when institutional quality is interacted with the spatial lag, meaningful coefficients emerge: better-governed regions transmit and absorb growth shocks more effectively. The policy implication is that trade connectivity alone does not generate convergence --- institutional capacity determines whether proximity to a growing neighbor is an asset or irrelevant.
{% endhint %}
...
This hierarchy has spatial multiplier consequences. Moretti (2010) estimated that each additional high-skill tradable-sector job generates close to 2.5 additional jobs in local non-tradable services: baristas, cleaners, restaurant workers, healthcare support staff. The multiplier is larger for innovation-intensive jobs (5:1) than for manufacturing (about 1.6:1), because innovation workers earn more and consume more skill-intensive local services. The concentration of APS employment in superstar metros thus produces a proportional concentration of non-tradable service employment, with wages set by the interaction of high-income demand and local housing costs.
...
International education is one of North America's largest Mode 2 services exports: one million foreign students enrolled in US institutions in 2024, at an estimated value exceeding $40 billion annually (IIE 2024; NAFSA 2024). The spatial geography is concentrated not in New York or Los Angeles but in college towns — Ithaca, Ann Arbor, Champaign-Urbana, State College — where the international student premium provides a substantial export earnings stream largely independent of the local industrial economy.
...
{% hint style="info" %}
**GATS Modes of Services Trade.** The WTO's General Agreement on Trade in Services distinguishes four modes: *Mode 1* (cross-border delivery --- a Mexican call center serving US clients), *Mode 2* (consumption abroad --- a foreign student at a US university), *Mode 3* (commercial presence --- a Japanese bank opening a New York office), and *Mode 4* (movement of natural persons --- a Canadian engineer working temporarily in the US). USMCA's digital trade provisions primarily facilitate Mode 1; its temporary entry provisions govern Mode 4; international education is Mode 2. Each mode has a distinct spatial footprint, and most trade data captures only goods trade plus limited Mode 1 services.
{% endhint %}
...
Figure 4.3 presents the SAR coefficient estimates from Lab 1, showing how the spatial lag parameter and interaction terms shift across baseline and institutional-interaction specifications.
...
The lesson extends beyond USMCA. Every trade agreement creates an institutional demand — capabilities that participating regions must possess to capture benefits. Regions with those capabilities gain; regions without them fall further behind. The institution, not the agreement text alone, determines whether gains materialize.
