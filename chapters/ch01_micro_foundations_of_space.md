...
By the mid-2000s, Bangalore's information technology and IT-enabled services sector employed around 400,000 workers — the largest concentration in India — and its software exports accounted for a substantial and growing share of the national total. By the mid-2010s, the city's IT workforce had surpassed one million. Kolkata's IT sector existed but remained an order of magnitude smaller, despite comparable access to technical graduates.

This divergence is, in a precise sense, an equilibrium phenomenon. Both cities had the underlying human capital to become IT centres. Neither had an insurmountable natural advantage. What Bangalore had was a sequence of early perturbations — IISc, the defence PSU cluster, the Texas Instruments uplink — that created just enough of a labour market head start to trigger the self-reinforcing feedback that Paul Krugman formalized: workers go where firms are; firms go where workers are; the resulting agglomeration is self-sustaining. Calcutta experienced a different sequence of shocks and locked into a different equilibrium. The spatial pattern of India's IT industry was not foreordained by geography. It was made by history.
...
Consider a simple fact: the Boston–Washington corridor, stretching about 700 kilometers along the US Northeast coast, accounts for 20 percent of American GDP while occupying less than 2 percent of its land area. The Pearl River Delta — Guangzhou, Shenzhen, Hong Kong — has transformed from a network of fishing villages into the world's most productive manufacturing complex in less than two generations, despite being located in a subtropical estuary with no particular resource endowment. Luxembourg, a landlocked country smaller than Rhode Island, hosts more financial assets per capita than Switzerland. None of these concentrations were geographically predetermined. Natural resources are not the explanation.
...
The answer depends on the geometry of Weber's **locational triangle**: the three vertices are the two raw material sources and the market, and the plant should locate at the point that minimizes the weighted sum of distances, where the weights are the tons of each input and output that must be moved. The **material index** is not that location; it is the ratio of the weight of localized material inputs to the weight of the finished product. A material index above one indicates a weight-losing process and, other things equal, a pull toward input sources. A value below one indicates a stronger market orientation.
...
Central place theory has had a complicated reception. Its predictions are most accurate in environments that match its assumptions: flat terrain, dispersed agricultural populations, and high transport costs. The US Great Plains and the North German Plain display something close to Christallerian settlement hierarchies; dense mountainous regions, coastal agglomerations, and post-industrial metros do not. Threshold demand allows fixed setup costs and firm-level scale economies to determine which services a settlement can support. What the framework lacks is an endogenous account of localized external economies and cumulative firm-worker feedback. It can explain why a high-order service requires a large market area, but not why Detroit became a car cluster or Houston became an energy cluster. As a theory of retail and service provision across a settlement hierarchy, it remains useful; as a theory of industrial agglomeration, it is incomplete.
...
The first force is **market access**, closely related to the home market effect Krugman (1980) formalized. Because production has a fixed cost, firms prefer the larger market: locating near more consumers reduces the cost of serving them. Manufacturing firms also bring mobile workers, enlarging local expenditure and attracting additional firms.

The second force is the **cost-of-living or price-index effect**. A region containing more manufacturing varieties offers workers cheaper access to a wider consumption bundle because fewer varieties incur iceberg trade costs. That raises the real wage and attracts more mobile workers, further enlarging the local market. These mutually reinforcing market-access and price-index effects drive agglomeration in the basic Krugman (1991) model.

This mechanism should not be confused with the **input-output linkages** in later New Economic Geography models. In the basic model described here, manufacturing uses labor, not manufactured intermediate inputs. Venables (1996) and related extensions add firms that buy and sell intermediates, producing backward linkages through local input demand and forward linkages through local input supply.

**Centrifugal (dispersing) forces:**

Against these agglomerating forces stands the immobility of farmers and the land they cultivate. Agricultural workers constitute a fraction $$\phi$$ of each region's population that cannot be lured to the manufacturing core (in the original Krugman (1991) formulation, $$\phi$$ is related to but distinct from the expenditure share $$\mu$$). They represent purchasing power that remains dispersed — and dispersed demand creates an incentive for at least some manufacturing to remain near the agricultural periphery to avoid transport costs. This centrifugal force weakens as the agricultural population share $$\phi$$ falls (as it has, globally, over the past century). A second centrifugal force is **local competition**: more manufacturers in a region means more intense product-market competition, which limits profit margins and wage bids.
...
### Beyond the Basic Model: Bell-Shaped Regional Inequality

The basic Krugman (1991) model establishes how falling transport costs can destabilize a dispersed equilibrium and produce core-periphery agglomeration. It does **not**, with the assumptions stated above, establish a general second transition in which still lower transport costs restore dispersion. That result requires additional mechanisms.

Extensions surveyed by Ottaviano and Puga (1998), Puga (1999), and Fujita, Krugman, and Venables (1999) can generate a **bell-shaped relationship** between integration and regional inequality. At high trade costs, production remains dispersed to serve local markets. At intermediate costs, market-access and linkage effects favor concentration. At sufficiently low costs, centrifugal forces introduced by the extension — such as immobile labor, congestion, land or housing costs, or reduced dependence on proximity to downstream buyers — can induce re-dispersion. The shape is therefore a conditional prediction of particular models, not a universal implication of the two-region core-periphery benchmark.

European economic history offers suggestive rather than decisive evidence for this pattern (Ottaviano and Puga 1998; Puga 1999). Industrialization produced sharp concentration in several periods and sectors, while later manufacturing diffusion and policy-supported convergence reduced some regional gaps. Services and high-technology activity subsequently reconcentrated in major cities. Because technology, sectoral composition, housing constraints, and regional policy changed simultaneously with trade costs, these episodes cannot be read as a clean test of a single bell-shaped mechanism.
...
Tabuchi (1998) and Tabuchi and Thisse (2002) extended the model to multiple regions, showing that the stark core-periphery prediction is sensitive to the two-region setup: with three or more regions, equilibria with partial dispersion across multiple cities emerge, a result that matches observed urban systems better than the extreme agglomeration of the two-region model.

| Model | Key mobile force | Main centrifugal force | Distinctive result |
|---|---|---|---|
| Krugman (1991) | Manufacturing workers | Immobile agricultural demand and local competition | Falling trade costs can destabilize symmetry and sustain core–periphery agglomeration |
| Venables (1996) | Firms linked through intermediate inputs | Competition and dispersed final demand | Backward and forward input-output linkages can generate industrial agglomeration without labor mobility |
| Helpman (1998) | Workers and differentiated production | Non-tradeable housing and rising local rents | Housing costs limit city size and offset productivity advantages |
| Puga (1999) | Workers and firms under alternative labor-market assumptions | Wage, demand, and congestion forces that vary by specification | Particular extensions can generate the rise and later decline of regional inequality as integration deepens |
| Tabuchi (1998); Tabuchi and Thisse (2002) | Workers across multiple locations | Competition, commuting, and land-market forces | Multi-region systems permit partial concentration and multiple city sizes rather than a single core |

The table is a safeguard against treating “the NEG model” as one invariant set of assumptions. Its predictions depend on which agents move, which goods are traded, and which congestion or immobility mechanism prevents complete concentration.
...
Glaeser et al. (1992) tested both hypotheses on US city employment data and found that Jacobs externalities — diversification, not specialization — more reliably predict employment growth in urban industries. This has important policy implications: industrial strategies that try to build monocultures (a "semiconductor zone," a "biotech district") may be less effective than strategies that build ecosystems of related but distinct capabilities. Chapter 2 formalizes the Jacobs insight through the "related variety" framework (Frenken, Van Oort, and Verburg 2007), which operationalizes the idea that inter-industry spillovers require technological proximity.
...
### Cross-Border Functional Regions and Transnational Networks

The most striking challenge to administrative spatial definitions is the existence of **cross-border functional regions** — contiguous economic systems that span national boundaries and operate as integrated labor, consumer, or production markets despite a regulatory discontinuity at the border. Examples include the Øresund region and the San Diego–Tijuana metropolitan economy.

Spatial economics also studies **transnational production and innovation networks** whose nodes are distant rather than contiguous. The Silicon Valley–Hsinchu connection is a prominent example. Santa Clara County and Hsinchu Science Park are 9,000 kilometers apart and do not form one labor market or commuting region, so calling them a single functional region would stretch that term beyond its usual meaning. They are tightly connected nodes in a semiconductor innovation network. Taiwanese engineers who trained at Stanford and Berkeley returned to Taiwan to help build firms including TSMC and UMC while maintaining investment and knowledge-sharing relationships with Bay Area colleagues (Saxenian 2006). The network carries capital and tacit knowledge about process chemistry, yield management, customer requirements, and technology roadmaps.
...
But agglomeration does not merely attract *more* firms and workers to dense locations — it attracts *particular kinds* of firms. The next section introduces a framework for understanding how firm-level productivity heterogeneity interacts with spatial sorting to produce patterns of regional inequality that the NEG's representative-firm models cannot fully explain.

---

## 1.6 Heterogeneous Firms and Spatial Sorting

The models surveyed so far share an important simplification: within each industry, firms are identical. In Krugman's core-periphery model, every manufacturing firm has the same productivity, the same fixed cost, and the same markup. The agglomeration decision is about *where* to produce, not about *which firms* end up where. This is a consequential abstraction. In the real economy, firms within the same narrowly defined industry differ enormously in productivity — by a factor of two or more between the 90th and 10th percentile, even after controlling for inputs (Syverson 2004). Once we allow for this heterogeneity, agglomeration becomes not just a story about spatial concentration but a story about spatial *selection*: the sorting of heterogeneous firms across locations, with the most productive gravitating toward the densest and most expensive places.

### The Melitz Framework: Trade and Within-Industry Reallocation

The intellectual foundation is Melitz (2003), which was written as a trade model but whose logic extends naturally to spatial economics. In Melitz's framework, firms within an industry draw their productivity from an ex ante distribution when they enter the market. After entry, each firm discovers its productivity level and decides whether to produce for the domestic market only, export to foreign markets, or exit entirely. The key mechanism is a set of fixed costs that create productivity *thresholds*. To survive at all, a firm must be productive enough to cover its fixed operating costs. To export, it must be productive enough to cover an additional fixed cost of entering foreign markets — adapting products to foreign standards, establishing distribution networks, navigating foreign regulations. Trade liberalization, by reducing variable trade costs, raises the revenue available from exporting and thereby lowers the productivity threshold for export entry — but it simultaneously intensifies import competition, raising the threshold for domestic survival. The result is within-industry reallocation: the most productive firms expand into export markets, the least productive firms are forced to exit, and aggregate industry productivity rises not because any individual firm becomes more efficient but because market share shifts toward the more productive survivors.

This is an elegant mechanism, and the empirical evidence for it is strong. Bernard, Jensen, and Schott (2006) document that US manufacturing plants in industries exposed to greater import competition from low-wage countries experienced sharply higher exit rates, with the exits concentrated among the least productive plants. The surviving plants — and particularly the exporters — were substantially more productive than the exiters, confirming the selection channel.

### From Trade Costs to Spatial Costs

The spatial extension of the Melitz logic follows a parallel structure, replacing trade costs with the costs of operating in a dense, expensive location. Agglomeration economies — the sharing, matching, and learning advantages documented in the Marshallian trinity — function as a productivity *premium* available to firms in dense locations. But dense locations also impose higher costs: land rents, wages bid up by competition for skilled labor, congestion. Only firms productive enough to cover these higher costs while still profiting from the agglomeration premium will sort into core regions. Less productive firms, unable to pay core-region rents and still break even, sort into peripheral locations where costs are lower but agglomeration benefits are thinner.

Combes, Duranton, Gobillon, Puga, and Roux (2012) provide the most rigorous empirical test of this spatial selection mechanism. Using French establishment-level data, they decompose the urban productivity advantage into two components: a *genuine agglomeration effect* (firms in dense areas are more productive because of spillovers, thick labor markets, and input sharing) and a *selection effect* (dense areas have higher average productivity because they attract inherently more productive firms). Their method exploits the shape of the entire productivity distribution across cities, not just its mean. If agglomeration works purely through spillovers, the productivity distribution in dense cities should be a rightward *shift* of the distribution in less dense cities — every firm benefits equally. If selection is also at work, the distribution in dense cities should additionally show *left truncation* — the least productive firms that would survive in a small city cannot survive in a large one. Combes et al. find evidence for both mechanisms, with selection accounting for a meaningful share of the observed urban productivity premium. Agglomeration raises everyone's game, but it also culls the weakest players.

Gaubert (2018) builds on this insight with a structural model that endogenizes the sorting of heterogeneous firms across cities. In her framework, more productive firms choose larger cities because the agglomeration benefits — better access to suppliers, deeper labor pools, proximity to demanding customers — are worth more to high-productivity firms than to low-productivity ones. The returns to agglomeration are *complementary* with firm ability: a brilliant software engineer benefits more from being in a deep labor market than a mediocre one does, and a highly productive manufacturer benefits more from proximity to specialized suppliers than a firm producing commodity goods. This complementarity generates an equilibrium in which firm productivity and city size are positively correlated — not because large cities make firms productive (though they do, via spillovers), but because productive firms select into large cities. Gaubert estimates that firm sorting accounts for roughly one-quarter to one-third of the observed productivity differences between large and small French cities.

### Implications for Regional Inequality

The firm-sorting mechanism has profound implications for understanding regional divergence — implications that go beyond the demand-linkage stories of the NEG. In the Krugman model, peripheral regions lose out because firms relocate to the core for market access. In the firm-heterogeneity framework, peripheral regions lose out for a more insidious reason: they retain only the firms that *cannot afford to leave*. The periphery does not just have fewer firms; it has less productive firms. This distinction matters for policy. A regional development strategy that succeeds in attracting new firms to a lagging region may be attracting precisely the firms that were not productive enough to survive in the core — firms that will generate fewer spillovers, pay lower wages, and create less durable employment than policymakers hoped.

This framework also provides micro-foundations for the widely observed pattern of "left-behind" regions suffering not only a labor drain (skilled workers migrating to cities) but a productivity drain: the most capable firms, entrepreneurs, and business models gravitating toward dense urban cores. The two drains are mutually reinforcing. As the most productive firms depart, the agglomeration benefits available to remaining firms decline, making the region less attractive to the next marginal firm considering its location. The Marshallian trinity operates in reverse: the labor pool thins, input markets shrink, and the knowledge spillovers that depend on density evaporate. What remains is a low-level equilibrium — not unproductive in absolute terms, but systematically selected for lower productivity relative to the core.

{% hint style="info" %}
**Firm sorting and the productivity drain.** Agglomeration does not merely attract more firms to core regions — it attracts the *most productive* firms, those capable of paying higher rents and wages in exchange for thicker labor markets, richer spillovers, and better market access. Peripheral regions retain the firms that cannot afford the core. This spatial selection mechanism means that regional wage gaps reflect not only the agglomeration environment (the NEG story) but also the systematic sorting of firm quality across space (the Melitz-Gaubert story). Policies aimed at lagging regions must contend with both channels: improving the local business environment *and* overcoming the selection dynamics that drain the most productive firms away.
{% endhint %}

The logic extends readily to services — and this matters increasingly as services account for the majority of economic activity in most countries. The most productive management consulting firms, law practices, software companies, and financial intermediaries cluster in global cities (London, New York, Singapore, Tokyo) for precisely the same reasons that the most productive manufacturers cluster in industrial cores: the agglomeration premium is worth more to them. A top-tier consulting firm benefits enormously from proximity to Fortune 500 headquarters, from the ability to recruit from a deep pool of MBA graduates, and from the knowledge spillovers that flow through the professional networks of a global city. A smaller, less productive firm cannot monetize these advantages as effectively and is better off in a secondary city where rents are lower. The result is spatial sorting in services that mirrors the Melitz logic — and that helps explain why global cities command such extraordinary wage premia in professional services, even for tasks that could in principle be performed remotely.

The chapters that follow will return to these themes repeatedly. The productivity drain from peripheral regions is visible in Latin American urbanization patterns (Chapter 4), in the extreme spatial concentration of India's IT services sector in a handful of cities (Chapter 8), in the selective sorting of high-value manufacturing into East Asia's coastal agglomerations (Chapter 6), and in the challenges facing European cohesion policy as it tries to raise productivity in regions that have been systematically selected against (Chapter 9). Firm heterogeneity and spatial sorting are not an alternative to the NEG — they are its necessary complement, adding the micro-level selection mechanism that transforms agglomeration from a story about *where things happen* into a story about *which firms end up where, and why that matters for everyone else*.
...
The raw (pooled OLS) estimate of $$\alpha$$ in US data is typically 0.04 to 0.06. Adding individual-level controls for education, experience, and occupation reduces the estimate to around 0.025 to 0.04 — indicating that half the raw urban wage premium reflects worker sorting rather than the agglomeration environment itself.
