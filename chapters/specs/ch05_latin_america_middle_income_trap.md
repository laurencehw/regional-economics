...
4. **Green commodity frontiers (lithium, hydrogen, critical minerals) risk reproducing the resource curse pattern unless paired with institutional upgrading.** The Andean lithium triangle and Southern Cone hydrogen ambitions face the same governance challenges as earlier commodity booms; spatial analysis of prior boom-bust cycles identifies which institutional preconditions distinguish upgrading from enclave extraction. Central American climate migration adds a further spatial force: rising temperatures, drought frequency, and hurricane intensity in the Central American Dry Corridor are displacing agricultural populations, generating intra-regional and northward migration flows that reshape labor markets in both origin and destination regions — making climate exposure a direct driver of spatial economic restructuring across LAC.
...
6. **Path Dependency (from Ch 2):** Historical colonial, industrial, and political legacies shape the spatial distribution of institutional capacity across Latin America — and it is here, in the middle-income trap application, that path dependency comes alive as an explanatory variable rather than an abstraction. Colonial extraction zones (mining corridors, plantation economies) bequeathed institutional structures optimized for rent capture rather than broad-based upgrading; import-substitution-era industrial policy concentrated manufacturing in a handful of primate cities; and political legacies of centralization vs. federalism determine which sub-national regions have the fiscal and regulatory autonomy to respond to contemporary trade opportunities. Moved from old Chapter 2 to this applied context where the mechanism can be tested against spatial data.
7. **Digital labor platforms and BPO create a new services-trade channel for LAC integration.** Platform-mediated digital labor (Upwork, Freelancer, Rappi, MercadoLibre) connects LAC freelancers and service workers to US and European clients, creating a form of "telemigration" (Baldwin 2019) that operates through Mode 1 (cross-border supply). Language proximity (Spanish-speaking US market), time-zone alignment, and lower wage costs create a natural comparative advantage for LAC in nearshore services — but institutional barriers (contract enforcement, payment infrastructure, intellectual property protection) determine which regions capture this opportunity. Medical tourism (Connell 2013) inverts the offshoring logic — consumers moving to the service — with Mexico, Costa Rica, and Colombia emerging as destination clusters. Tourism more broadly operates as the Mode 2 case study for how a tradable service generates non-tradable employment multipliers (Faber & Gaubert 2019).
8. **Tourism as Spatial Strategy (Mode 2):** Mexico's coastline and the Caribbean basin represent the most spatially concentrated Mode 2 service export clusters in the Americas. Faber & Gaubert (2019) provide rigorous causal identification of tourism's local development effects along Mexico's coast, showing how resort development generates employment multipliers that extend into non-tradable hinterland economies. The Airbnb disruption (Zervas, Proserpio & Byers 2017) adds a new spatial dimension: platform-mediated short-term rentals redistribute tourism revenue away from traditional hotel zones into residential neighborhoods, altering the intra-urban geography of tourism gains — but also generating housing affordability pressures that reshape local welfare calculus. The Caribbean tourism monoculture illustrates both the growth potential and the vulnerability of Mode 2 specialization: climate exposure, cruise-line monopsony power, and seasonal demand volatility create a distinctive risk profile for tourism-dependent regions.
...
- **Informal trade undercounting:** ECLAC estimates that 40-60% of Andean cross-border trade is informal — unrecorded flows that bypass customs infrastructure entirely (contraband, small-scale border commerce, undocumented re-exports). This systematic undercounting means that official trade statistics substantially understate the actual economic integration of border regions, biasing any gravity-model or spatial-interaction analysis that relies on recorded bilateral flows.
- **Measuring "premature deindustrialization" in a heterogeneous services sector:** The analytical challenge of diagnosing premature deindustrialization is compounded by the fact that the services sector absorbing displaced manufacturing workers ranges from high-productivity fintech and BPO to street vending and informal domestic services. Standard sectoral classification systems (ISIC, national accounts) aggregate these activities under common headings, making it difficult to distinguish productive structural transformation (manufacturing → tradable services) from distressed informalization (manufacturing → subsistence services) at the sub-national level.
...
6. Zervas, Proserpio & Byers (2017), "The Rise of the Sharing Economy: Estimating the Impact of Airbnb on the Hotel Industry," *Journal of Marketing Research* — identifies the competitive displacement and spatial redistribution effects of platform-mediated short-term rentals on incumbent tourism infrastructure.
...
- Tourism agglomeration map: Mexican coastline resort corridors (Cancún-Riviera Maya, Los Cabos, Puerto Vallarta-Nayarit) and Caribbean basin tourism clusters, showing spatial concentration of Mode 2 service exports, hotel/Airbnb density gradients, and hinterland employment multiplier reach.
