...
## Required Datasets
- VIIRS night-lights annual composites (same source as Lab 6 / Ch. 12).
...
- Required code artifacts:
  - `labs/lab6_africa/code/prepare_lab5_inputs.py` (existing)
