...
| P1 | Border proxy coverage too narrow (3 of 44 countries) | Prototype broader friction proxy using World Bank LPI and compare against BTS-only proxy. | In progress | 2026-03-07 |
...
4. Run LPI-based proxy build and compare spec results against BTS-only baseline for 2024 gate.
